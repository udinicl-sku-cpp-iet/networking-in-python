...
#     ##############################################################
#     if ipv4_to_value("255.255.0.0") == 4294901760 and ipv4_to_value("1.2.3.4") == 16909060:
#         print(True)
#     else:
#         print(False)
#     ##############################################################
#     if value_to_ipv4(4294901760) == "255.255.0.0" and value_to_ipv4(16909060) == "1.2.3.4":
#         print(True)
#     else:
#         print(False)
#     ##############################################################
#     if get_subnet_mask_value("/16")            == 0b11111111111111110000000000000000 and\
#        get_subnet_mask_value("10.20.30.40/23") == 0b11111111111111111111111000000000:
#         print(True)
#     else:
#         print(False)
#     ##############################################################
#     if ips_same_subnet("10.23.121.17", "10.23.121.225", "/23") == True and\
#        ips_same_subnet("10.23.230.22", "10.24.121.225", "/16") == False:
#         print(True)
#     else:
#         print(False)
#     ##############################################################
#     if get_network(0x01020304,0xffffff00) == 0x01020300:
#         print(True)
#     else:
#         print(False)
#     ##############################################################
...
#     ip1 = "1.2.3.5"
#     ip2 = "1.2.5.6"
#     if find_router_for_ip(routers, ip1) == "1.2.3.1" and\
#         find_router_for_ip(routers, ip2) == None:
#         print(True)
#     else:
#         print(False)
